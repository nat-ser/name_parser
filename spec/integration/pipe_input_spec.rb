...
describe "Pipe delimited file sorts by test columns" do
  let(:input_path) { "spec/fixtures/input_pipe.csv" }
...
describe "Pipe delimited file sorts by alternative columns" do
  let(:input_path) { "spec/fixtures/input_pipe.csv" }
  let(:output_path) { "spec/fixtures/output_test.csv" }
